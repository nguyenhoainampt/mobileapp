      ...
      btn1.addEventListener('click', function() {
        ...
        /*******************************************************/
         ...
         let parn2="です。";
          switch (n) {
            case 0:
              console.log(parn1+"Very Happy!!!!!"+parn2);
              break;
            case 1:
              console.log(parn1+"Happy!!!"+parn2);
              break;
            case 2:
              console.log(parn1+"Funny!"+parn2);
              break;
            case 3:
              console.log(parn1+"sad.."+parn2);
              break;
            case 4:
              console.log(parn1+"Bad....."+parn2);
              break;
          }
